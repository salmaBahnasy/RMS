...
import { approveTransferEmp, transferRequests } from "../../../../constants/ServicesNames";
...
const getAllEmpTransferRequests = async (pageNumber:number): Promise<ApprovalRequest[]> => {
  ...
  try {
    ...
    const url = `${BaseURL}${transferRequests}?pageNumber=${pageNumber}&pageSize=10`;
    console.log('url:', url);
